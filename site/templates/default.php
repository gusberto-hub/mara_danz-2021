...
<main id="start-screen">
    <div hidden>
        ...
        <img class='start-screen-bg' src="<?= $bgImage->url() ?>" width="<?= $bgImage->width() ?>" height="<?= $bgImage->height() ?>">
    </div>
    <div hidden>
        <?php $bgImageMobile = $site->background_mobile()->toFile()->thumb($options = ['height' => 1000]) ?>
        <img class='start-screen-bg-mobile' src="<?= $bgImageMobile->url() ?>" width="<?= $bgImageMobile->width() ?>" height="<?= $bgImageMobile->height() ?>">
    </div>


    <?php if ($site->logo_layer()->isNotEmpty()) : ?>
        <div class="start-screen-logo">
            <?php $logoStartScreen = $site->logo_layer()->toFile()->thumb($options = ['height' => 1000]) ?>
            <img src="<?= $logoStartScreen->url() ?>" alt="" width="<?= $logoStartScreen->width() ?>" height="<?= $logoStartScreen->height() ?>">
        </div>
    <?php endif ?>
